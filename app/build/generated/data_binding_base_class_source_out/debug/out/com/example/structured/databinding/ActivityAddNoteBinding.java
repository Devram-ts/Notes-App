...
public final class ActivityAddNoteBinding implements ViewBinding {
  ...
  private ActivityAddNoteBinding(@NonNull ConstraintLayout rootView, @NonNull Button addbtn,
      @NonNull EditText description, @NonNull EditText notetitle, @NonNull TextView textView2) {
  ...
  public static ActivityAddNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddNoteBinding((ConstraintLayout) rootView, addbtn, description, notetitle,
          textView2);
    }
