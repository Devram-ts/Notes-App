...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton addbtn1;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton addbtn1, @NonNull RecyclerView notesRecyclerView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.addbtn1;
      FloatingActionButton addbtn1 = ViewBindings.findChildViewById(rootView, id);
      if (addbtn1 == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, addbtn1, notesRecyclerView,
          textView);
    }
